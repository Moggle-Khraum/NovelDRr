...
export default function ReaderScreen() {
  ...
  // Refs so speakSentence closure always reads latest values without re-creating
  ...
  // Load TTS settings + available voices on mount
  useEffect(() => {
    (async () => {
      try {
      ...
      try {
        ...
        // Filter to English voices only, dedupe by identifier
  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      <View style={styles.scrollWrapper}>
        ...
        {/* Floating TTS button — tap to play/stop, long press for settings */}
        <Pressable
      ...
      >
        ...
        >
          <Pressable
            style={[styles.ttsModalSheet, { backgroundColor: colors.surface }]}
            onPress={() => {}}
          >
            {/* Handle */}
            ...
            <View style={styles.ttsSettingRow}>
              ...
              <Slider
                ...
                onSlidingComplete={(v) => saveTTSSettings(v, ttsPitch, ttsVoiceId)}
              />
            ...
            <View style={styles.ttsSettingRow}>
              ...
              <Slider
                ...
                onSlidingComplete={(v) => saveTTSSettings(ttsRate, v, ttsVoiceId)}
              />
              <View style={styles.ttsSliderLabels}>
                    ...
                    return (
                      <Pressable
                        ...
                        onPress={() => {
                          ...
                          saveTTSSettings(ttsRate, ttsPitch, voice.identifier);
                        }}
                      >
                        <Text style={[
